...
OUT  = Path("artifacts/models/consumption_xgb.pkl"); OUT.parent.mkdir(parents=True, exist_ok=True)
...
model.fit(Xtr,ytr)
print(f"[LOAD] MAE={mean_absolute_error(yte, model.predict(Xte)):.3f} kWh")
