...
# -*- coding: utf-8 -*-
"""
train_consumption.py  –  XGBoost baseline for load_kw
"""
...
def parse_timestamp(df: pd.DataFrame) -> pd.DataFrame:
    ...
    if df["timestamp"].dt.tz is None:             # якщо tz-naive → локалізуємо
...
def train():
    ...
    with open(MODEL_DIR / "consumption_xgb.pkl", "wb") as f:
        pickle.dump(models, f)

    print("✅  consumption_xgb.pkl saved")
